...
def randomHeaders():
    """ Returns dictionary with random headers """
    browser = random.choice(list(user_agents.keys()))
    version = random.choice(user_agents[browser])
...
def specificUserAgent(browser):
    """ Returns dictionary with User-Agent header set to specific browser, eg. Chrome, Opera or IE  """
