...
if __name__ == '__main__':
    results = main()
    schema = ['source', 'lastUpdate', 'host', 'port', 'country', 'speed', 'type', 'anonymity']
    resultsHandler.saveResultsAsCSV(results, '/home/tulski/Desktop/free-proxy-list-net.csv', schema=schema)